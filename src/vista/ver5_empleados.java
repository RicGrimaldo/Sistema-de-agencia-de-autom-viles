...
public class ver5_empleados extends javax.swing.JFrame {
     ...
     */
    //Se crea un objeto "modelo" de la clase TablaVigilancia
    ...
    public ver5_empleados() {
        ...
        InicializarTabla();//Método para inicializar la tabla con los empleados de vigilancia registrados
    }
    
    public void InicializarTabla(){
        //Se llama al método de la clase para llenar la clase TablaVigilancia para llenar la tabla
        modelo.iniciarTabla(this.TablaVigilancia);        
    }
    //Cadena pública necesaria para pasarla como parámetro a la ventana "nuevo5_empleado"
    //y saber qué clave será la del empleado a modificar
    public static String Clave_modificacion = "";
    
    //Método para saber si no hay empleados vigilantes registrados
    private boolean Tabla_Vacia(){
        ...
        for(int i=0;i<Interfaz_Proyectofinal.listaEmpleados.size();i++){
            if(Interfaz_Proyectofinal.listaEmpleados.get(i) instanceof Vigilante){
                bandera = false;//Devuelve false en caso que haya mínimo un empleado vigilante registrado
                break;
            }
        }
        return bandera;
    ...
    //Método para saber si hay otro empleado de vigilancia con la misma clave
    ...
    private void btEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEliminarActionPerformed
        ...
        int posicion = 0;
        try{//Primero se verifica si la tabla de mantenimiento está vacía
            if(Tabla_Vacia() == true){
                ...
                if(Clave_repetida(Clave) == true){//Primero, se verifica si hay un empleado con esa clave
                    ...
                    while(posicion<Interfaz_Proyectofinal.listaEmpleados.size()){
                        ...
                        if(Clave.equals(Interfaz_Proyectofinal.listaEmpleados.get(posicion).getClave()) == true){
                            //Se verifica que sea de tipo vigilancia
    ...
    private void btModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btModificarActionPerformed
        try{
            if(Tabla_Vacia() == true){
                ...
                //Primero, se verifica si existe un empleado de vigilancia con dicha clave
                if(Clave_repetida(Clave_modificacion) == true){
                    //En caso de que se encuentre, se abre la ventana para crear un nuevo 
                    //empleado vigilante, pero para modificar el empleado seleccionado
                    nuevo5_empleado ventana = new nuevo5_empleado();
                    ventana.setVisible(true);
                    this.dispose();
                }
