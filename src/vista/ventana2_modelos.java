 ...
 * @author asha2
 */
public class ventana2_modelos extends javax.swing.JFrame {

    /**
     * Creates new form ventana2_modelos
     */
    public ventana2_modelos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btAutosRacing = new javax.swing.JButton();
        btGamaCupra = new javax.swing.JButton();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Diseño sin título (36).png"))); // NOI18N

        btAutosRacing.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Copia de Copia de Copia de Sin título (14).png"))); // NOI18N
        btAutosRacing.setText("jButton5");
        btAutosRacing.setFocusable(false);
        btAutosRacing.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btAutosRacingActionPerformed(evt);
            }
        });

        btGamaCupra.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Copia de Copia de Copia de Sin título (13).png"))); // NOI18N
        btGamaCupra.setText("jButton5");
        btGamaCupra.setFocusable(false);
        btGamaCupra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btGamaCupraActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(147, 147, 147)
                        .addComponent(btGamaCupra, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(btAutosRacing, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(120, 120, 120)
                        .addComponent(btGamaCupra, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btAutosRacing, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(41, 41, 41)
                        .addComponent(jLabel1)))
    ...
    private void btGamaCupraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGamaCupraActionPerformed
        modelo_elegir VentanaGama = new modelo_elegir();
        this.dispose();
        VentanaGama.setVisible(true);
    }//GEN-LAST:event_btGamaCupraActionPerformed
    ...
    private void btAutosRacingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAutosRacingActionPerformed
        modelo2_elegir ventanaAutosRacing = new modelo2_elegir();
        this.dispose();
        ventanaAutosRacing.setVisible(true);
    }//GEN-LAST:event_btAutosRacingActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventana2_modelos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventana2_modelos().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btAutosRacing;
    private javax.swing.JButton btEmpleados;
    private javax.swing.JButton btFacServicios;
    private javax.swing.JButton btGamaCupra;
